...
// Layered bottom-up tree layout: root at the bottom, leaves at the top.
// x = midpoint of subtree leaf span (a proper tree shape).
function computeLayout(nodes: NodeWithStatus[]): Layout {
