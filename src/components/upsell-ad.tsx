...
const ADS: Record<string, { emoji: string; title: string; text: string; cta: string; plan: string }[]> = {
  free: [
    { emoji: "🌱", title: "Sari Sprout → Sari Bloom", text: "3× more matching jobs a day, 10× the AI credits and 10 daily swaps.", cta: "Upgrade to Bloom ($5)", plan: "basic" },
    { emoji: "🌱", title: "Sari Sprout → Sari Money Club", text: "Unlimited matching jobs, 200 AI credits and 30 swaps a day.", cta: "Join Money Club ($10)", plan: "pro" },
  ...
  basic: [
    { emoji: "👑", title: "Sari Bloom → Sari Money Club", text: "Unlimited matching jobs, 200 AI credits a month and 30 daily swaps.", cta: "Join Money Club ($10)", plan: "pro" },
