      ...
      <Card className="w-full max-w-md relative z-10">
        ...
        <CardContent>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white dark:bg-dark-card px-2 text-slate-400">or</span></div>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 mt-4">
            ...
            <Link href="/auth/signup" className="text-kawaii-purple font-semibold hover:underline">Sign Up</Link>
          </p>
        </CardContent>
      </Card>
    </div>
