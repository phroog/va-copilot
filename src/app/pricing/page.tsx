...
const TIERS = [
  {
    ...
    features: ["20 Job-Ansichten pro Tag", "5 AI-Credits / Monat", "Scam-Ampel & Match", "Live-Feed (Vorschau)"],
    cta: "Get Started",
    highlight: false,
  },
  {
    ...
    features: ["100 Job-Ansichten pro Tag", "50 AI-Credits / Monat", "Volle Beschreibungen + Links", "Pitch-Generator", "CV & PDF"],
    cta: "Start Basic",
    highlight: false,
  },
  {
    ...
    features: ["Unbegrenzte Job-Ansichten", "200 AI-Credits / Monat", "Alle Plattformen voll", "Prioritäts- & Deep-Match", "Alles aus Basic"],
    cta: "Start Pro",
    highlight: true,
  },
];
