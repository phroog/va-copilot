              ...
              <CardContent className="p-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <div className="relative">
                    ...
                    {menuOpen === app.id && (
                      <div className="absolute right-0 top-full mt-1 z-50 bg-white dark:bg-dark-card border border-kawaii-lavender/30 dark:border-dark-surface rounded-2xl shadow-xl p-1 w-44 max-h-[50vh] overflow-y-auto">
