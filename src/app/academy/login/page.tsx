    ...
    <div className="flex items-center justify-center min-h-[70vh] px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">{t("academyLogin")}</CardTitle>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t("academyLoginDesc")}</p>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-center text-sm text-slate-500">
            {t("noAccount")}{" "}
            <Link href="/academy/signup" className="text-kawaii-purple dark:text-kawaii-lavender font-bold hover:underline">{t("signup")}</Link>
          </p>
